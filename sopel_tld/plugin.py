...
This version copyright 2025 dgw, technobabbl.es

Portions derived from `tld.py` as shipped with Sopel 8.0:
https://github.com/sopel-irc/sopel/blob/86c73dbb9040351e48c453266d9c0e241302e252/sopel/builtins/tld.py

Copyright 2009-2010 Michael Yanovich, yanovich.net
...
class WikipediaTLDListParser(HTMLParser):
    ...
    def handle_starttag(self, tag, attrs):
        if tag == 'td' or tag == 'th':
            self.in_cell = True
        elif tag in ('sup', 'style') and self.in_cell:
            # ignore style tags, naturally
            # also ignore superscripts; they're almost exclusively footnotes
            self.skipping = True
        elif tag == 'table':
